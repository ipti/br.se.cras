<?php $__env->startSection('main-content'); ?>      
  ...
  <form action="<?php echo e(url("/family/$id->identificacao_usuario")); ?>"  method="post" name="formulario" id="formulario">
      ...
      <div class="row" id="box1">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="input-group" id="">
                  ...
                  <input type="text" name="id" value="<?php echo e($id->id); ?>" disabled >
                </div>
              </div>
      </div>
            ...
            <div  class="row" id="box1">
              ...
              <input type="text" class="form-control"   name="data_entrada" id="data_entrada"  value="<?php echo e($id->data_inicial); ?>" >
                </div>
              ...
              <div class="input-group" id="">
                ...
                <input type="text" class="form-control"   name="data_saida"  id="data_saida" value="<?php echo e($id->data_final); ?>" >
              </div>
              </div>
          ...
          <br>
           <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="input-group " id="" >
              ...
              <input  type="text" name="nome" style="text-transform: uppercase;" class="form-control" value="<?php echo e($id->nome); ?>" onkeypress="return lettersOnly(event);" >
            </div>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="input-group " id="" >
              <span class="input-group-addon">Apelido</span>
              <input  type="text" name="apelido" class="form-control" value="<?php echo e($id->apelido); ?>" onkeypress="return lettersOnly(event);" style="text-transform: uppercase;">
            </div>
          </div>
        </div>
        <div  class="row" id="box1">
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="input-group" id="">
              <span class="input-group-addon">Data de Nascimento</span>
               <input type="text" class="form-control"   name="data_nascimento"  value="<?php echo e($id->data_nascimento); ?>"  >
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="input-group " id="" >
              <span class="input-group-addon">Nº Cadastro</span>
              <input  type="text" name="NumeroCadastro" class="form-control" value="<?php echo e($id->certidao_nascimento); ?>" >
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="input-group " id="" >
              <span class="input-group-addon">NIS</span>
              <input  type="number" name="nis" onkeyups ="somenteNumeros(this)" class="form-control" value="<?php echo e($id->NIS); ?>" >
            </div>
          </div>
        </div>
        <div  class="row" id="box1">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="input-group" id="">
              ...
              <input  type="text" name="rgNumero" class="form-control" value="<?php echo e($id->numero_rg); ?>"
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="input-group " id="">
              ...
              <input  type="text" name="RgEmissao" class="form-control" value="<?php echo e($id->data_emissao_rg); ?>" >
            </div>
          </div>
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="input-group " id="" >
              ...
              <select class="form-control" name="RGuf"     >
                <option selected=""><?php echo e("$id->uf_rg"); ?></option>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="input-group " id="" >
              ...
              <input  type="text" name="RgOrgaoEmissor" class="form-control" onkeypress="return lettersOnly(event);" value="<?php echo e($id->emissao_rg); ?>" style="text-transform: uppercase;">
            </div>
          </div>
        </div>
        <div  class="row" id="box1">
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="input-group" id="">
              ...
              <input  type="text"  name="cpf"  class="form-control" value="<?php echo e($id->cpf); ?>" id="cpf" title="Informe um nome válido." data-inputmask='"mask": "(999) 999-9999"' >
            </div>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="radio4" >
        ...
        <div  class="row" id="box1">
          <div class="col-md-12 col-sm-6 col-xs-12">
            <div class="input-group " id="" >
              ...
              <input  type="text" name="mae" class="form-control" value="<?php echo e($id->mae); ?>"  onkeypress="return lettersOnly(event);" style="text-transform: uppercase;">
            </div>
          </div>
        </div>
        <div  class="row" id="box1">
          <div class="col-md-12 col-sm-6 col-xs-12">
            <div class="input-group " id="" >
              ...
              <input  type="text" name="pai"  class="form-control" value="<?php echo e($id->pai); ?>"  onkeypress="return lettersOnly(event);" style="text-transform: uppercase;">
            </div>
          </div>
        </div>
        <div  class="row" id="box1">
          <div class="col-md-12 col-sm-6 col-xs-12">
            <div class="radio" >
              ...
              <br>
              <?php if($id->estado_civil === 'solteiro'): ?>
              <label id="opcao">
              ...
              <?php elseif($id->estado_civil === 'casado'): ?>
              <label id="opcao">
              ...
              <label  id="opcao">
                <input type="radio" name="estadoCivil"      id="" value="outro" >
                Outro
              </label>  <?php elseif($id->estado_civil === 'separado'): ?>
              <label id="opcao">
                <input type="radio" name="estadoCivil"      id="" value="solteiro"  >
                Solteiro
              </label>
              ...
              <label  id="opcao">
                <input type="radio" name="estadoCivil"      id="" value="outro" >
                Outro
              </label> <?php elseif($id->estado_civil === 'divorciado'): ?>
              <label id="opcao">
                <input type="radio" name="estadoCivil"      id="" value="solteiro" >
                Solteiro
              </label>
              ...
              <?php elseif($id->estado_civil === 'viuvo'): ?>
              <label id="opcao">
                <input type="radio" name="estadoCivil"      id="" value="solteiro"  >
                Solteiro
              </label>
              ...
              <label  id="opcao">
                <input type="radio" name="estadoCivil"      id="" value="outro"  >
                Outro
              </label> <?php elseif($id->estado_civil === 'outro'): ?>
              <label id="opcao">
                <input type="radio" name="estadoCivil"      id="" value="solteiro"  >
                Solteiro
              </label>
          ...
          <div  class="row" id="box1">
            <div class="col-md-12 col-sm-6 col-xs-12">
              <div class="input-group " id="" >
                ...
                <input  type="text" name="address"     class="form-control" value="<?php echo e($id->endereco); ?>" id=""  >
              </div>
            </div>
          </div>
          <div  class="row" id="box1" >
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group" id="">
                ...
                <input  type="text" name="telefone" class="form-control" value="<?php echo e($id->telefone); ?>" title="Informe um nome válido." >
              </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group " id="" >
                <span class="input-group-addon">Ponto de Referência</span>
                <input  type="text" name="pontoReferencia"     class="form-control" value="<?php echo e($id->ponto_referencia); ?>" id="" title="Informe um nome válido." >
              </div>
            </div>
          </div>
          <div  class="row" id="box1">
            <div class="col-md-12 col-sm-6 col-xs-12">
              <div class="radio2">
                ...
                <br>
                <?php if($id->condicoes_moradia === 'propria'): ?>
                <label id="opcao1">
                ...
                <?php elseif($id->condicoes_moradia === 'alugada'): ?>
                <label id="opcao1">
                ...
                <label  id="opcao1">
                 ...
                 <?php elseif($id->condicoes_moradia === 'cedida'): ?>
                <label id="opcao1">
                  <input type="radio" name="condicoesMoradia"      id="" value="propria" >
                  Própria
                </label>
                ...
                <label  id="opcao1">
                  ...
                  Área de Ocupação
                   ...
                   <?php elseif($id->condicoes_moradia === 'areaDeOcupacao'): ?>
                <label id="opcao1">
                  <input type="radio" name="condicoesMoradia"      id="" value="propria" >
                  Própria
                </label>
          ...
          <div  class="row" id="box1">
            <div class="col-md-12 col-sm-6 col-xs-12">
              <div class="radio2">
                ...
                <br>
                <?php if($id->tipo_construcao === 'alvenaria'): ?>
                <label id="opcao1">
                ...
                <label  id="opcao1">
                 ...
                 <?php elseif($id->tipo_construcao === 'madeira'): ?>
                <label id="opcao1">
                ...
                <?php elseif($id->tipo_construcao === 'mista'): ?>
                <label id="opcao1">
                  <input type="radio" name="tipoConstrucao"      id="" value="alvenaria"  >
                  Alvenaria
                </label>
                ...
                <label  id="opcao1">
                 ...
                 <?php elseif($id->tipo_construcao === 'taipa'): ?>
                <label id="opcao1">
                  <input type="radio" name="tipoConstrucao"      id="" value="alvenaria"  >
                  Alvenaria
                </label>
          ...
          <div  class="row" id="box1" >
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group" id="">
                ...
                <input  type="text" name="qtdComodos"     class="form-control" value="<?php echo e($id->comodos); ?>" id="" title="Informe um nome válido." >
              </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group " id="" >
                <span class="input-group-addon">Valor (Aluguel ou Financiamento)</span>
                <input  type="text" name="valorAluguel"     class="form-control" value="<?php echo e($id->comodos); ?>" id="" title="Informe um nome válido." >
              </div>
            </div>
          </div>
          <br><br>
        ...
        <div id="textaba3" class="divunsel">
          ...
          <div  class="row" id="box1">
            <div class="col-md-12 col-sm-6 col-xs-12">
              ...
              <?php if($id->ocupacao_irregular === 1): ?>
                <label id="opcao1">
              ...
              <?php endif; ?>
              <?php if($id->idosos_dependentes === 1): ?>
                <label id="opcao1">
          ...
          <div  class="row" id="box1" >
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group" id="">
                ...
                <input  type="text" name="profissao"     class="form-control" value="<?php echo e($id->profissao); ?>" id="" title="Informe um nome válido."  >
              </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="radio3">
                ...
                <br>
                <?php if($id->carteira_assinada === 'sim'): ?>
                <label id="opcao2">
          ...
          <div  class="row" id="box1" >
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="input-group" id="">
                ...
                <input  type="number" name="rendaMensalUsuario"  value="<?php echo e($id->renda); ?>"  >
              </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="radio4">
                ...
                <?php if($id->reside_familia == 'familia'): ?>
                <label id="opcao3">
                ...
                <?php elseif($id->reside_familia == 'soziho'): ?>
                <label id="opcao3">
                <input type="hidden" name="reside" value="0">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <label id="opcao4">
                  ...
                  <input style=height:1%!important; type="number" class="form-control" name="loas" 
                    value="<?php echo e($id->loasbpc); ?>" required=""/>
                ...
                <label id="opcao4">
                 ...
                 value="<?php echo e($id->bolsa_familia); ?>" /><span class=input-group-addon><span>R$</span></span></div>
                </label>
              <br>
            </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <input style=height:1%!important; type="number" class="form-control" name="previdencia" required="" 
                 value="<?php echo e($id->previdencia); ?>" /><span class=input-group-addon><span>R$</span></span></div>
                </label>
                ...
                <input style=height:1%!important; type="number" class="form-control" disabled="" name="rendaTotal" required="" 
                 value="<?php echo e($total); ?>" /><span class=input-group-addon><span>R$</span></span></div>
                </label>
