<head>
    ...
    <script src="<?php echo e(url('/js/sweetalert.min.js')); ?>" type="text/javascript"></script>

    <link href="<?php echo e(asset('/css/sweetalert.css')); ?>" rel="stylesheet" type="text/css" />

  <link href="<?php echo e(asset('/plugins/dataTables.bootstrap.css')); ?>" rel="stylesheet" type="text/css" />
