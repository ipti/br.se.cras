...
<form action="<?php echo e(url("/attendance/edit/$id->id/$id->id_atendimento")); ?>"  method="post" name="formulario" id="formulario">
      ...
      <h3 class="box-title" style="padding-left: 1%;">Atendimento de Atendimentos
        ...
        <hr>   			           
            <div  class="row" id="box1">
              ...
              <input type="text" class="form-control"  value=<?php echo e($id->data); ?> name="data_atendimento" id="data_atendimento"  placeholder="Data do atendimento" required="" value="">              
                </div>
              </div>
            </div>
             ...
             <div class="input-group">
                  ...
                  <select class="form-control"  name="servico">
                    <?php $__empty_1 = true; $__currentLoopData = $servico; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                      <option value="<?php echo e($serv->id); ?>" name="servico"><?php echo e($serv->nome); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="input-group " id="" >
              ...
              <input  type="text" name="socicitacao" class="form-control" value="<?php echo e($id->solicitacao); ?>" title="Informe um nome válido." >
            </div>
          </div>
        </div>
        <div  class="row" id="box1">
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="input-group " id="" >
              ...
              <input  type="text" name="providencia"      class="form-control" value="<?php echo e($id->encaminhamento); ?>" title="Informe um nome válido." >
            </div>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="input-group " id="" >
              <span class="input-group-addon">Resultado</span>
              <input  type="text" name="resultado"      class="form-control" value="<?php echo e($id->resultado); ?>" title="Informe um nome válido."  >
            </div>
          </div>
        </div>
        <div  class="row" id="box1">
        	<div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="input-group">
                            ...
                            <option value="<?php echo e($tecnico[0]->id); ?>" name="tecnico"><?php echo e($tecnico[0]->nome); ?></option>
