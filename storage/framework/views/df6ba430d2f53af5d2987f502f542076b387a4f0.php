...
<!-- Laravel App -->
  <script src="<?php echo e(url('//ajax.googleapis.com/ajax/libs/jquery/1/jquery.js')); ?>"></script>
<script src="<?php echo e(url('https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js')); ?>"></script>  


<script src="<?php echo e(url (mix('/js/app.js'))); ?>" type="text/javascript"></script>
<!-- <script src="<?php echo e(url ('/js/jquery-3.2.1.js')); ?>" type="text/javascript"></script> -->
<script src="<?php echo e(url('/js/tabelaCadastro.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(url('/js/pagesCadastro.js')); ?>" type="text/javascript"></script>

<script src="<?php echo e(asset('/js/jquery.mask.min.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('/plugins/jquery.dataTables.js')); ?>"></script>
<script src="<?php echo e(asset('/plugins/dataTables.bootstrap.min.js')); ?>"></script>

<script src="<?php echo e(asset('/plugins/jquery.inputmask.js')); ?>"></script>
<script src="<?php echo e(asset('/plugins/jquery.inputmask.date.extensions.js')); ?>"></script>
